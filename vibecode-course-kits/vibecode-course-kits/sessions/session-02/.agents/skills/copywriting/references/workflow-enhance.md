...
1. **Screenshots provided** → Analyze directly to describe issues in detail
2. **Videos provided** → Analyze directly to extract relevant copy issues
3. **Scout codebase** → explore the codebase (e.g. parallel `Explore` subagents) to find files needing enhancement
